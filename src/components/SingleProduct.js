      ...
      <ThemeProvider theme={theme}>
        ...
        <div className="container mx-auto max-w-screen-2xl grid grid-cols-12 md:grid-rows-[55px_minmax(500px,_1fr)] md:gap-8 md:px-4 lg:px-6">
          ...
          <div className="hidden md:block m-4 col-span-8 lg:col-span-9">
            {/* breadCrumbs */}
            <div className="flex bg-white rounded-sm p-2 items-center gap-2 mr-5">
              <span className="text-orange-400">تلفن همراه</span>
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="col-span-12 md:mx-4 md:col-span-8 lg:col-span-9">
            {/* single product */}
            <div className="px-4 flex flex-col items-center gap-y-9">
            ...
            <div className="text-slate-800 text-xs md:text-lg mt-6 mb-10 flex flex-wrap justify-around gap-x-2 gap-y-4">
              <div className="flex items-center">
                <div className="flex items-center">
                  <span>
                    <svg
